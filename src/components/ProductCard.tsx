  ...
  return (
    <>
      <Card className="flex gap-3 items-center justify-center p-4 hover:bg-accent/50 transition-colors duration-200 group">
        <div className="w-16 h-16 rounded-full overflow-hidden mb-4 group-hover:scale-110 transition-transform duration-200">
          <img
        ...
        <div className="flex-1">
          ...
          <span className="text-secondary-foreground bg-gray-100 text-xs px-2 py-1 rounded mt-1 inline-block">
            {product.category}
          </span>
        </div>
